<div class="modal modal-blur fade" id="modal-edit-{{ $d->id }}" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('beli-dress.update', $d->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="modal-body">
                    <script>
                        var hargaBarang = {
                            "Short Sleeve Dress": 80000,
                            "Eclaire - Malika Dress": 150000,
                            "Midi Dress Lengan Pendek": 75000
                        };
                    ...
                    <div class="mb-3">
                        ...
                        <select name="nama" class="form-control" id="nama" onchange="updateHarga()">
                           ...
                           <option value="Short Sleeve Dress">Short Sleeve Dress</option>
                            <option value="Eclaire - Malika Dress">Eclaire - Malika Dress</option>
                            <option value="Midi Dress Lengan Pendek">Midi Dress Lengan Pendek</option>
                        </select>
                    </div>
                    <div class="mb-3">
